...
export class QueryCommodityListDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 10,
    default: 10,
    maximum: COMMODITY_LIST_MAX_PAGE_SIZE
  })
  @IsOptional()
  @Transform(({ value }) => toOptionalNumber(value))
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: "排序字段",
    enum: CommodityListSortBy,
    default: CommodityListSortBy.CreatedAt
  })
  @IsOptional()
