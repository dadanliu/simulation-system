...
export class QueryAuditLogDto {
  ...
  @ApiPropertyOptional({ description: "开始时间，ISO8601", example: "2026-04-28T00:00:00.000Z" })
  @IsOptional()
  @IsISO8601()
  createdFrom?: string;

  @ApiPropertyOptional({ description: "结束时间，ISO8601", example: "2026-04-28T23:59:59.999Z" })
  @IsOptional()
  @IsISO8601()
  createdTo?: string;
  ...
  @ApiPropertyOptional({ description: "每页数量，最大 100", example: 20, default: 20, maximum: AUDIT_LOG_MAX_PAGE_SIZE })
  @IsOptional()
  @Transform(({ value }) => toOptionalNumber(value))
  @IsInt()
  @Min(1)
